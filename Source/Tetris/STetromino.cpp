...
ASTetromino::ASTetromino()
{
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> mat(TEXT("MaterialInterface'/Game/Materials/mSTetromino.mSTetromino'"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> flux(TEXT("/Game/Materials/FluxMaterials/mSFluxBlock.mSFluxBlock"));
