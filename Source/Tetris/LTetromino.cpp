...
ALTetromino::ALTetromino()
{
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> mat(TEXT("MaterialInterface'/Game/Materials/mLTetromino.mLTetromino'"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> flux(TEXT("/Game/Materials/FluxMaterials/mLFluxBlock.mLFluxBlock"));
