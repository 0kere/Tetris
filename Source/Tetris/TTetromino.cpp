...
{
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> mat(TEXT("MaterialInterface'/Game/Materials/mTTetromino.mTTetromino'"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> flux(TEXT("/Game/Materials/FluxMaterials/mTFluxBlock.mTFluxBlock"));
