...
AITetromino::AITetromino()
{
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> mat(TEXT("MaterialInterface'/Game/Materials/mITetromino.mITetromino'"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> flux(TEXT("MaterialInterface'/Game/Materials/FluxMaterials/mIFluxBlock.mIFluxBlock'"));
...
void AITetromino::BeginPlay()
{
	...
	spawningCoords[3] = FVector2D(2, 0);
